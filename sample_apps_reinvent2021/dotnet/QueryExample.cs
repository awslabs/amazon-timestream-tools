...
namespace TimestreamDotNetSample
{
    public class QueryExample
    {
        ...
        public static string SELECT_ALL_QUERY = $"SELECT * FROM {Constants.DATABASE_NAME}.{Constants.TABLE_NAME}";
        ...
        private static string QUERY_3 = $@"SELECT BIN(time, 30s) AS binned_timestamp, ROUND(AVG(cpu_utilization), 2) AS avg_cpu_utilization, 
