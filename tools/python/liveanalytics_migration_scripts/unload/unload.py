...
if __name__ == "__main__":
    ...
    parser.add_argument("-atn", "--add-time-ns", help="Add time_ns column in export to preserve timestamp precision during migration", default=False, type=lambda x: x.lower() in ['true', '1', 'yes'], required=False)
