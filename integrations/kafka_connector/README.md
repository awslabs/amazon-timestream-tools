...
| 7  | timestream.target.liveanalytics        | true/false enable or disable ingestion of data into Timestream for LiveAnalytics                                              | true                                                                                                                                                                                                             |Yes | NONE |
| 8  | timestream.target.influxdb             | true/false enable or disable ingestion of data into Timestream for InfluxDB                                                   | true                                                                                                                                                                                                             |Yes | NONE |
...
| 19 | timestream.influxdb.bucket             | InfluxDB bucket to write data to, must be present | Required for InfluxDB when target enabled                                                                                                                                                                        | Yes | NONE |
...
| 22 | timestream.influxdb.token              | API token for InfluxDB | equired for InfluxDB when target enabled                                                                                                           | Yes  | NONE |
