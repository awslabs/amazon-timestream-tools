...
class QueryExample:
    ...
    SELECT_ALL = "SELECT * FROM " + DATABASE_NAME + "." + TABLE_NAME
    ...
    queries = [QUERY_1, QUERY_2, QUERY_3, QUERY_4, QUERY_5, QUERY_6, QUERY_7, QUERY_8, QUERY_9, QUERY_10, QUERY_11, QUERY_12]
