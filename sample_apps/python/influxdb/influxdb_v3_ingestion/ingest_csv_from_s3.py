...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(prog="ingest_csv_from_s3")
    parser.add_argument(
        "--host",
        required=True,
        help=(
    ...
    parser.add_argument(
        "--s3-bucket-name",
        required=True,
        help="The name of the S3 bucket that holds CSV data.",
    )
    parser.add_argument(
        "--s3-object-key",
        default="influxdb_v3_sample_data/sample_data.csv",
        required=False,
        help='The object key of the CSV data file within the S3 bucket. For example, "influxdb_v3_sample_data/sample_data.csv".',
    )
