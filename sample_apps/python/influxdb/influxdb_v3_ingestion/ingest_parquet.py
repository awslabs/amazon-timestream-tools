...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(prog="ingest_parquet")
    parser.add_argument(
        "--file-path",
        required=False,
        default="./data/sample_data.parquet",
        help=(
            "The path to the Parquet file data "
            'to ingest. For example, "./data/sample_data.parquet".'
        ),
    )
    parser.add_argument(
        "--host",
